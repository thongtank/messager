                    ...
                    <div class="col-md-6">
                        <form action="insert_department.php" method="POST" class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="department" id="department" class="form-control" placeholder="เพิ่มแผนกวิชา">
                            </div>
                            <div class="form-group">
                                <label for="tel">Tel.</label>
                                <input type="text" name="tel" id="tel" class="form-control" placeholder="กรอกเบอร์โทรศัพท์" pattern="[0-9]{0,10}">
                            </div>
                            <div class="form-group">
                                <input type="submit" value="เพิ่มแผนก" class="btn btn-default pull-right">
                            </div>
                        </form>
                    </div>
                    <div class="col-md-6">
